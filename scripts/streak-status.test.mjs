...
if (!USE_OLD) {
  ...
  check('the restart notice no longer carries the restore (it is its own block)', () => {
    assert.doesNotMatch(home, /restoreOffer\(/, 'index.tsx still decides the restore inside the notice');
