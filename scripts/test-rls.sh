...
# squads_test covers naming, joining several, leaving, the cascade, and
# re-proves isolation now that membership is many-to-many.
for t in supabase/tests/rls_test.sql supabase/tests/missed_day_test.sql supabase/tests/challenge_length_test.sql supabase/tests/squads_test.sql; do
  echo "===== $t"
